...
//           <p className="mt-4 max-w-4xl text-lg text-white/90 leading-8">
...
//           <div className="mt-6 flex flex-wrap gap-6 text-sm text-white/70 bg-white/10 rounded-xl p-4 inline-block">
...
//       {/* Content */}
//       <div className="max-w-7xl mx-auto px-2 lg:px-8 py-20">
...
//                     <a
//                       href={`#${item.id}`}
//                       className="text-gray-600 hover:text-primary-800 transition-colors duration-200 flex items-center gap-2 group"
//                     >
//                       <span className="w-1.5 h-1.5 rounded-full bg-gray-300 group-hover:bg-primary-800 transition-colors duration-200"></span>
//                       {item.label}
//                     </a>
//                   </li>
//                 ))}
...
//             <section id="who-we-are" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   1
//                 </span>
...
//             <section id="information" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   2
//                 </span>
...
//             <section id="usage" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   3
//                 </span>
...
//             <section id="sharing" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   4
//                 </span>
...
//             <section id="transfers" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   5
//                 </span>
...
//             <section id="retention" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   6
//                 </span>
...
//             <section id="rights" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   8
//                 </span>
...
//             <section id="cookies" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   9
//                 </span>
...
//             <section id="children" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   10
//                 </span>
...
//             <section id="changes" className="mb-24 scroll-mt-28">
//               <div className="flex items-center gap-3 mb-8">
//                 <span className="bg-primary-100 text-primary-800 font-semibold text-sm px-3 py-1 rounded-full">
//                   11
//                 </span>
...
//               <div className="bg-primary-800 text-white rounded-2xl sm:rounded-3xl p-2 lg:p-16 relative overflow-hidden">
...
//                       <div className="flex-shrink-0 w-10 h-10 bg-white/15 rounded-lg flex items-center justify-center mt-0.5">
//                         <svg
...
//                           className="text-slate-300 text-sm sm:text-base break-all hover:text-white transition-colors"
//                         >
...
//                           className="text-blue-300 text-sm sm:text-base hover:text-blue-200 transition-colors break-all"
//                         >
//                           innovise-it.com
//                         </a>
//                       </div>
