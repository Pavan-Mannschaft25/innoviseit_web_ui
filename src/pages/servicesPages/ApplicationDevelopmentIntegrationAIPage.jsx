...
//               <button className="btn-primary px-8 py-4 rounded-xl font-semibold text-white flex items-center gap-2 shadow-lg hover:shadow-xl transition-all">
...
//                     <i className="fas fa-network-wired text-4xl text-white mb-2"></i>
...
//     <section
//       ref={ref}
//       className={`py-28 px-4 md:px-8 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
//     >
...
//     <section
//       ref={ref}
//       className={`py-28 px-4 md:px-8 bg-slate-50 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
//     >
//       <div className="max-w-7xl mx-auto">
//         <div className="text-center mb-16">
//           <p className="text-amber-600 font-bold mb-4 uppercase tracking-wider text-sm">
...
//                 >
//                   <caseStudy.icon className="text-xl text-white" />
//                 </div>
...
//     <section
//       ref={ref}
//       className={`py-28 px-4 md:px-8 relative overflow-hidden transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
//       style={{
//         background:
...
//         <div className="grid lg:grid-cols-2 gap-16 items-center">
//           <div>
//             <p className="text-white/90 font-bold mb-4 uppercase tracking-wider text-sm">
//               AI Innovation
//             </p>
//             <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
//               Unlock the Power of
//               <br />
//               <span className="text-white/90">Artificial Intelligence</span>
//             </h2>
...
//           <button className="btn-primary px-10 py-4 rounded-xl font-semibold text-white flex items-center gap-2 text-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
...
//               }}
//             >
//               <FaCube className="text-white font-bold text-lg" />
//             </div>
...
//               >
//                 <SocialIcon className="text-slate-400 group-hover:text-white transition-colors" />
//               </a>
//             ))}
//           </div>
//         </div>
