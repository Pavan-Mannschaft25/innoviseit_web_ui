...
//     {/* ===== OVERLAY — directional: dark left, transparent right ===== */}
//     <div className="absolute inset-0" aria-hidden="true">
//       {/* Main directional gradient — THIS is the key fix */}
//       <div
//         className="absolute inset-0"
//         style={{
//           background:
//             "linear-gradient(105deg, rgba(7,11,35,0.95) 0%, rgba(7,11,35,0.88) 35%, rgba(7,11,35,0.45) 55%, rgba(7,11,35,0.15) 75%, transparent 100%)",
//         }}
//       />
//     </div>
...
//       <div className="max-w-7xl mx-auto px-4 lg:px-8 w-full py-24 lg:py-0">
...
//               <FaCogs className="text-lg text-white" />
//             </div>
...
//             className="text-4xl md:text-5xl lg:text-[3.5rem] xl:text-[4rem] font-black text-white leading-[1.08] mb-7"
//           >
//             Transforming Enterprises with{" "}
