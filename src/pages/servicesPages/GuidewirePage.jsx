...
//     description:
//       "End-to-end Guidewire implementation services tailored for modern insurance enterprises.",

//     features: [
//       "PolicyCenter Setup",
//       "ClaimsCenter Deployment",
...
//     description:
//       "Seamless integration between Guidewire and enterprise applications, APIs, and cloud systems.",
...
//     id: 3,
//     icon: FaShieldAlt,
//     title: "Guidewire Testing",
//     description:
//       "Automation and QA testing services ensuring stable and reliable insurance applications.",
...
//     description:
//       "24/7 application management and production support services for Guidewire ecosystems.",
...
//     id: 5,
//     icon: FaRocket,
//     title: "Guidewire Upgrades",
//     description:
//       "Smooth migration and version upgrades with minimal business disruption.",

//     features: ["Version Migration", "Data Validation", "Deployment Support"],
...
//     description:
//       "Secure insurance operations with governance, compliance, and vulnerability management.",

//     features: ["Security Assessments", "Compliance Checks", "Risk Monitoring"],
...
//     description:
//       "Accelerate insurance workflows with optimized Guidewire systems.",
//   },

//   {
//     icon: FaUsers,
//     title: "Better Customer Experience",
//     description: "Deliver seamless digital experiences for policyholders.",
//   },
...
//     title: "Scalable Insurance Platform",
//     description:
//       "Future-ready Guidewire environments built for business growth.",
//   },
// ];
...
//         style={{
//           background: hovered
//             ? `linear-gradient(135deg,#081C34 0%,#102B4C 100%)`
//             : `linear-gradient(135deg,#0A1A2F 0%,#163B66 100%)`,
...
//         }}
//       >
//         <div className="absolute inset-0 bg-[#081C34]/80" />

//         <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10 py-24">
...
//               }}
//             >
//               <FaCloud style={{ color: BRAND.gold.primary }} />
...
//             {/* Heading */}
//             <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-[1.1] text-white mb-6">
//               Accelerating{" "}
//               <span
//                 style={{
...
//               Empower your insurance business with scalable Guidewire
//               implementation, integration, testing, and support services
...
//               <a
//                 href="#services"
//                 className="px-8 py-4 rounded-xl border text-white font-semibold"
//                 style={{
...
//                 { icon: FaUsers, text: "Insurance Expertise" },
...
//               Modern insurance transformation powered by Guidewire
//               implementation, testing, integrations, and managed support.
//             </p>
//           </div>
...
//                 style={{ color: "#64748B" }}
//               >
//                 We help insurance organizations modernize operations, improve
//                 customer experience, and accelerate digital transformation
//                 initiatives.
//               </p>
...
//             Transform Insurance Operations with{" "}
//             <span
//               style={{
//                 backgroundImage: BRAND.gold.gradient,
//                 WebkitBackgroundClip: "text",
...
//               }}
//             >
//               Guidewire Excellence
//             </span>
//           </h2>

//           <p className="text-lg text-white/70 leading-relaxed mb-10 max-w-2xl mx-auto">
//             Empower your insurance business with scalable Guidewire solutions,
//             enterprise integrations, and continuous application support designed
//             for digital transformation.
//           </p>

//           <a
//             href="/contact"
//             className="inline-flex items-center gap-3 px-10 py-5 rounded-xl font-bold text-lg transition-all duration-300 hover:-translate-y-1"
//             style={{
//               background: BRAND.gold.gradient,
//               color: BRAND.navy.dark,
//             }}
