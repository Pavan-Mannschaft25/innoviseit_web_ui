    ...
    <div className="group relative h-full w-full flex flex-col">
      ...
      >
        ...
        <div className="flex-1 p-6 lg:p-7 flex flex-col min-h-0 relative">
          ...
          {/* Title */}
          <h3
            className="text-xl lg:text-2xl font-bold mb-3 leading-tight tracking-tight line-clamp-2 transition-all duration-300"
            style={{ color: COLORS.navy.dark }}
          >
            {data.title}
          </h3>
          ...
          {data.features && data.features.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-5 flex-shrink-0">
              {data.features.slice(0, 4).map((feature, idx) => (
                <span
                  key={idx}
                  className="px-3 py-1.5 rounded-lg text-xs font-medium cursor-default transition-all duration-300 hover:-translate-y-0.5"
                  style={{
                    background: `${COLORS.navy.dark}06`,
                    color: COLORS.navy.mid,
                    border: `1px solid ${COLORS.navy.dark}12`,
          ...
          {/* ================================ */}
          <div
            className="mt-auto pt-5 border-t-2"
            style={{ borderColor: "rgba(11,29,51,0.06)" }}
          >
            <Link
              to={data.link}
              className="group/btn relative w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-bold text-sm uppercase tracking-wide transition-all duration-300 overflow-hidden"
              style={{
                background: COLORS.navy.dark,
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = COLORS.gold.gradient;
                e.currentTarget.style.color = COLORS.navy.dark;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = COLORS.navy.dark;
