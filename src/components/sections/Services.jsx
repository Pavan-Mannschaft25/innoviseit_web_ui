...
//       description:
//         "Comprehensive project assessment, recovery, implementation, and optimization services to ensure successful SAP transformations.",
//       features: [
//         "Project Recovery",
...
//       ],
//       link: "/services/project-remediation",
//     },
//     {
//       id: 2,
//       icon: FaTools,
...
//       description:
//         "End-to-end AMS support ensuring stability, performance, and continuous improvement of SAP landscapes.",
//       features: [
//         "L1 / L2 / L3 Support",
//         "Incident Management",
//         "System Monitoring",
...
//       description:
//         "Comprehensive SAP testing services that improve reliability and reduce deployment risks.",
//       features: [
//         "Functional Testing",
//         "Automation Testing",
//         "Regression Testing",
...
//       description:
//         "Secure and seamless migration of enterprise data across SAP systems and cloud platforms.",
//       features: [
//         "S/4HANA Migration",
...
//   return (
//     <section className="relative py-10 lg:py-12 overflow-hidden bg-gradient-to-br from-[#06152B] via-[#0B1D33] to-[#10284A]">
//       {/* Background Effects */}
//       <div className="absolute inset-0 overflow-hidden pointer-events-none">
//         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FDB913]/10 rounded-full blur-3xl" />
...
//       <Container>
//         {/* Header */}
//         <div className="text-center max-w-5xl mx-auto mb-16 lg:mb-20 relative z-10">
//           <span className="inline-flex items-center px-5 py-2 rounded-full bg-[#FDB913]/10 border border-[#FDB913]/20 text-[#FDB913] font-semibold text-sm mb-6">
//             CORE SERVICES
//           </span>
...
//             From project remediation and AMS support to quality engineering and
//             data transformation, Innovise IT delivers enterprise-grade solutions
...
//                     duration-500
//                     hover:-translate-y-2
//                     hover:border-[#FDB913]/40
//                     hover:shadow-[0_0_40px_rgba(253,185,19,0.15)]
//                   "
//                 >
//                   {/* Icon */}
//                   <div
...
//                     "
//                   >
//                     <Icon size={36} className="text-[#FDB913]" />
//                   </div>

//                   {/* Category */}
//                   <span className="inline-block px-4 py-1 rounded-full text-xs font-semibold bg-[#FDB913]/10 text-[#FDB913] mb-4">
//                     {service.category}
//                   </span>
...
//                       >
//                         <span className="w-2 h-2 rounded-full bg-[#FDB913]" />
//                         {feature}
//                       </div>
//                     ))}
//                   </div>
...
//                       "
//                     >
//                       <FaArrowRight className="text-[#06152B]" />
//                     </div>
//                   </div>

//                   {/* Hover Overlay */}
//                   <div className="absolute inset-0 bg-gradient-to-br from-[#FDB913]/5 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none" />
//                 </div>
//               </Link>
//             );
//           })}
...
//         {/* Stats */}
//         {/* <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-20 relative z-10">
...
//                 text-center
//                 transition-all duration-300
//                 hover:border-[#FDB913]/30
//                 hover:-translate-y-1
//               "
//             >
//               <h3 className="text-3xl lg:text-4xl font-bold text-[#FDB913]">
//                 {item.value}
//               </h3>
...
//       title: "Project Support & Remediation",
//       description:
//         "Assessment, implementation, recovery, and optimization services for successful SAP projects.",
//       link: "/services/project-remediation",
...
//       title: "Application Maintenance Services",
//       description:
//         "End-to-end AMS support ensuring stability, performance, and continuous improvement.",
//       link: "/services/app-maintenance",
//       button: "View Offerings",
//     },
//     {
//       id: 3,
//       icon: FaCheckCircle,
...
//       title: "Testing & QA",
//       description:
//         "Comprehensive testing solutions that improve reliability and reduce deployment risks.",
//       link: "/services/testing-qa",
//       button: "Learn More",
//     },
//     {
...
//       description:
//         "Secure migration, landscape transformation, and cloud modernization services.",
//       link: "/services/data-migration",
//       button: "Explore More",
//     },
//   ];
...
//             <span className="block bg-gradient-to-r from-[#FDB913] via-[#FFD54F] to-[#FDB913] bg-clip-text text-transparent">
//               Through SAP Innovation
//             </span>
//           </h2>
...
//     "
//           >
//             Delivering enterprise-grade SAP consulting, support, modernization,
//             migration, and digital transformation services for global
//             organizations.
//           </p>
//         </div>
