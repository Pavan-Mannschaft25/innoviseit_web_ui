...
const MixedMediaCinematic = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div
          className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center ${
            reverse ? "lg:flex-row-reverse" : ""
          }`}
        >
          ...
          >
            ...
            {/* Title - Word by Word Reveal */}
            <h2
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-[1.15] mb-7"
